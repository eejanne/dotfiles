...
require("diffview").setup({
  ...
  keymaps = {
    view = {
      ...
      { "n", "Å",          "[c",                                   { desc = "Jump to previous change/hunk" } },
      { "n", "å",          "]c",                                   { desc = "Jump to next change/hunk" } },
    ...
    file_panel = {
      ...
      { "n", "<tab>",         actions.select_next_entry,              { desc = "Open the diff for the next file" } },
      { "n", "<s-tab>",       actions.select_prev_entry,              { desc = "Open the diff for the previous file" } },
      { "n", "å",             "<C-w>l]c",                             { desc = "Jump to next change/hunk in diff" } },
      { "n", "Å",             "<C-w>l[c",                             { desc = "Jump to previous change/hunk in diff" } },
